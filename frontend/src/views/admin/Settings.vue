        ...
        <div>
          <div class="flex items-center justify-between mb-1">
            ...
            <button type="button" @click="useMyPosition" :disabled="locating" class="text-xs bg-blue-100 text-blue-700 px-3 py-1 rounded hover:bg-blue-200 disabled:opacity-50">
              <i v-if="locating" class="fas fa-spinner fa-spin mr-1"></i><i v-else class="fas fa-location-arrow mr-1"></i>
...
const form = ref({ official_opening_time: '08:00', company_latitude: null, company_longitude: null, geofence_radius_meters: 50 })
...
onMounted(async () => {
  try {
    ...
    if (data) form.value = { ...form.value, ...data, official_opening_time: data.official_opening_time?.substring(0, 5) || '08:00' }
