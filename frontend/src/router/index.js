...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'bulletins-paie', name: 'BulletinsPaie', component: () => import('@/views/employee/BulletinsPaie.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'paie', name: 'AdminPayroll', component: () => import('@/views/admin/Payroll.vue') },
